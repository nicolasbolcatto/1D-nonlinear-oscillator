function [fs,t,acc,vel,u,pt]=Newmark_general_linear(M,K,D,p0,w,dt,tt,tf)
%Function that performs a linear time integration analysis of a 1DOF
%oscillator based on a Newmark scheme. The load history on the
